				...
				<DialogPrimitive.Root open>
					<DialogPrimitive.Portal>
						...
						<DialogPrimitive.Content
							className={`
                h-fc md:top-50 md:left-50 fixed bottom-0 left-0 right-0 z-50 flex max-w-[1200px] flex-col items-center overflow-hidden rounded-2xl rounded-bl-none rounded-br-none border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 md:w-[40rem] md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-bl-2xl md:rounded-br-2xl lg:w-[40rem]`}
