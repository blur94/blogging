...
function PublicationSubscribeStandOut() {
	...
	return (
		<div className="my-10 mt-20 flex w-full flex-col items-center pb-10 md:px-5">
			<h3 className="font-heading mb-5 text-center text-2xl font-bold text-slate-900 dark:text-slate-50 md:text-3xl">
			...
			<p className="mb-5 text-center text-lg text-slate-700 dark:text-slate-300 md:w-2/3 md:text-xl">
				Read articles from {<strong>{publication!.title}</strong> || 'this blog'} directly inside
				your inbox. Subscribe to the newsletter, and don&apos;t miss out.
			</p>
			{!state.subscribed && (
