		...
		<DialogPrimitive.Root open>
			<DialogPrimitive.Portal>
				...
				<DialogPrimitive.Content
					className={twJoin(
						'md:w-108 fixed bottom-0 right-0 top-0 z-50 w-full transform-gpu overflow-auto border-slate-200 bg-white shadow-2xl transition-transform duration-300 ease-out dark:border-l dark:border-slate-700 dark:bg-slate-900',
						// When the sheet is mounted, we want to slide it in from the right.
						!isMounted ? 'md:translate-x-108 translate-x-full' : 'translate-x-0',
					)}
				>
					{children}
