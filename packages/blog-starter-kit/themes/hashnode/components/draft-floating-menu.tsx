...
function DraftFloatingMenu(props: { draft?: any; list: any[] }) {
	...
	return (
		<Tooltip.Provider delayDuration={200}>
			...
			<div className="post-floating-bar fixed left-0 right-0 z-50 flex h-12 w-full flex-wrap justify-center 2xl:h-14">
				<div className="border-1/2 mx-auto flex h-12 max-w-[380px] flex-wrap items-center justify-around rounded-full border-slate-200 bg-white px-5 py-1 text-sm  text-slate-800 shadow-lg dark:border-slate-500 dark:bg-slate-700 dark:text-slate-50 2xl:h-14">
