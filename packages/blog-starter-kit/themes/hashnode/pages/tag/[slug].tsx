...
import { PublicationFragment, TagInitialDocument, TagInitialQuery } from '../../generated/graphql';
						...
						<div className="flex w-full min-w-0 flex-col flex-wrap items-center md:flex-row xl:flex-nowrap">
							<div className="mb-5 w-full min-w-0 xl:mb-0 xl:flex-1 xl:pr-8">
								...
								<div className="truncate ">
									<h1 className="blog-series-title font-heading mb-2 pb-px text-3xl font-bold text-slate-900 dark:text-white md:text-4xl">
										{tag.name}
									</h1>
